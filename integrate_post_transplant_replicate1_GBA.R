...
# ATAC fragment file
frag.file <- "./processed_data/ILC2_post-transplant_rep1_atac_fragments.tsv.gz"
...
saveRDS(post_transplant, file = paste0(out.dir,"Post-transplant_SeuratObject_replicate1.rds"))
...
saveRDS(ilc.combined, file = paste0(out.dir,"Post-transplant_replicate1_GBA_integration.rds"))


# Save Session Info ------------------------------------------------------------
writeLines(capture.output(sessionInfo()), "./sessionInfo/integrate_post_transplant_replicate1_GBA_sessionInfo.txt")
