...
post_transplant <- readRDS(paste0(out.dir,"Post-transplant_SeuratObject_replicate2.rds"))


# Read Integrated Seurat Object ------------------------------------------------
ilc.combined <- readRDS(paste0(out.dir,"Post-transplant_GBA_integration.rds"))
...
# Data Visualization -----------------------------------------------------------
  ...
  ggsave(ilc.classification.plot,
         file = paste0(out.dir, "Fig2n_post-transpalnt_GBA_ILC_classification.pdf"),
         height = 4.6,
         width = 11,
         device = "pdf")
...
ggsave(Summary_ILC1_regulators,
       file = paste0(out.dir, "Fig2o_candidate_regulator_scatter_summary.pdf"),
       height = 6,
       width = 8,
       device = "pdf")

# Save Session Info ------------------------------------------------------------
writeLines(capture.output(sessionInfo()), "./sessionInfo/Figure_2n_o_sessionInfo.txt")
