# Integration of in vitro mouse ILC2 and pcILC2 data (replicate 2)
...
# Load Raw Data ----------------------------------------------------------------
ILC2.data <- Read10X_h5("./processed_data/ilc2_pre-transplant_rep2_filtered_feature_bc_matrix.h5")

pcILC2.data <- Read10X_h5("./processed_data/pcILC2_rep2_filtered_feature_bc_matrix.h5")
...
# ATAC fragment file
pcILC2.frag.file <- "./processed_data/pcILC2_rep2_atac_fragments.tsv.gz"
...
saveRDS(ilc.integrated, file = paste0(out.dir,"inVitro_ILC2_pcILC2_integrated_rep2.rds"))


# Save Session Info ------------------------------------------------------------
writeLines(capture.output(sessionInfo()), "./sessionInfo/inVitro_ILC2_pcILC2_integrated_rep2_sessionInfo.txt")
