...
jid10=$(sbatch --mem=100g --time=0-1 --parsable --dependency=afterok:$jid9 -N 1 -n 20 -o ./slurmOut/integrate_multiome_replicate2.R_%j.txt --wrap="apptainer exec --no-mount home --bind $PWD gvhd_R4.3.1.sif Rscript integrate_multiome_replicate2.R ")
...
jid19=$(sbatch --mem=30g --time=0-2 --parsable --dependency=afterok:$jid18 -N 1 -n 20 -o ./slurmOut/Figure_2h_%j.txt --wrap="apptainer exec --no-mount home --bind $PWD gvhd_R4.3.1.sif Rscript Figure_2h.R")
...
jid21=$(sbatch --mem=100g --time=0-1 --parsable --dependency=afterok:$jid20 -N 1 -n 20 -o ./slurmOut/integrate_post_transplant_replicate2_GBA_%j.txt --wrap="apptainer exec --no-mount home --bind $PWD gvhd_R4.3.1.sif Rscript integrate_post_transplant_replicate2_GBA.R")
...
jid26=$(sbatch --mem=100g --time=0-1 --parsable --dependency=afterok:$jid25 -N 1 -n 16 -o ./slurmOut/integrate_post_transplant_replicate1_GBA_%j.txt --wrap="apptainer exec --no-mount home --bind $PWD gvhd_R4.3.1.sif Rscript integrate_post_transplant_replicate1_GBA.R")
...
jid30=$(sbatch --mem=20g --time=0-5 --parsable -N 1 -n 1 -o ./slurmOut/mouse_ATAC_peak_union_set_%j.txt --wrap="apptainer exec --no-mount home --bind $PWD gvhd_R4.3.1.sif python mouse_ATAC_peak_union_set.py")
jid31=$(sbatch --mem=10g --time=0-1 --parsable --dependency=afterok:$jid30 -N 1 -n 1 -o ./slurmOut/generate_pcILC2_ILC2_ATAC_count_matrix_%j.txt --wrap="apptainer exec --no-mount home --bind $PWD gvhd_R4.3.1.sif Rscript generate_pcILC2_ILC2_ATAC_count_matrix.R")
jid32=$(sbatch --mem=10g --time=0-1 --parsable --dependency=afterok:$jid31 -N 1 -n 1 -o ./slurmOut/ILC2_pcILC2_ATAC_DESeq2_%j.txt --wrap="apptainer exec --no-mount home --bind $PWD gvhd_R4.3.1.sif Rscript ILC2_pcILC2_ATAC_DESeq2.R")
jid33=$(sbatch --mem=10g --time=0-1 --parsable --dependency=afterok:$jid32 -N 1 -n 4 -o ./slurmOut/Figure_3e_%j.txt --wrap="apptainer exec --no-mount home --bind $PWD gvhd_R4.3.1.sif ipython Figure_3e.py")
jid34=$(sbatch --mem=10g --time=0-0:15 --parsable --dependency=afterok:$jid33 -N 1 -n 1 -o ./slurmOut/Figure_3g_%j.txt --wrap="apptainer exec --no-mount home --bind $PWD gvhd_R4.3.1.sif Rscript Figure_3g.R")
jid35=$(sbatch --mem=30g --time=0-1 --parsable --dependency=afterok:$jid34 -N 1 -n 1 -o ./slurmOut/Figure_3h_%j.txt --wrap="apptainer exec --no-mount home --bind $PWD gvhd_R4.3.1.sif Rscript Figure_3h.R")
jid36=$(sbatch --mem=10g --time=0-1 --parsable --dependency=afterok:$jid35 -N 1 -n 1 -o ./slurmOut/Figure_3i_%j.txt --wrap="apptainer exec --no-mount home --bind $PWD gvhd_R4.3.1.sif Rscript Figure_3i.R")
jid37=$(sbatch --mem=10g --time=0-1 --parsable --dependency=afterok:$jid36 -N 1 -n 1 -o ./slurmOut/Figure_3j_%j.txt --wrap="apptainer exec --no-mount home --bind $PWD gvhd_R4.3.1.sif Rscript Figure_3j.R")
jid38=$(sbatch --mem=75g --time=0-2 --parsable --dependency=afterok:$jid37 -N 1 -n 4 -o ./slurmOut/Figure_3k_%j.txt --wrap="apptainer exec --no-mount home --bind $PWD gvhd_R4.3.1.sif Rscript Figure_3k.R")
jid39=$(sbatch --mem=100g --time=0-1 --parsable --dependency=afterok:$jid38 -N 1 -n 20 -o ./slurmOut/integrate_inVitro_ILC2_pcILC2_replicate2_%j.txt --wrap="apptainer exec --no-mount home --bind $PWD gvhd_R4.3.1.sif Rscript integrate_inVitro_ILC2_pcILC2_replicate2.R")
jid40=$(sbatch --mem=10g --time=0-1 --parsable --dependency=afterok:$jid39 -N 1 -n 1 -o ./slurmOut/ExtData_Figure_3c_%j.txt --wrap="apptainer exec --no-mount home --bind $PWD gvhd_R4.3.1.sif Rscript ExtData_Figure_3c.R")
jid41=$(sbatch --mem=35g --time=0-1 --parsable --dependency=afterok:$jid40 -N 1 -n 1 -o ./slurmOut/ExtData_Figure_3d_%j.txt --wrap="apptainer exec --no-mount home --bind $PWD gvhd_R4.3.1.sif Rscript ExtData_Figure_3d.R")
jid42=$(sbatch --mem=10g --time=0-1 --parsable --dependency=afterok:$jid41 -N 1 -n 1 -o ./slurmOut/ExtData_Figure_3e_f_%j.txt --wrap="apptainer exec --no-mount home --bind $PWD gvhd_R4.3.1.sif Rscript ExtData_Figure_3e_f.R")
jid43=$(sbatch --mem=10g --time=0-0:15 --parsable --dependency=afterok:$jid42 -N 1 -n 1 -o ./slurmOut/ExtData_Figure_3g_%j.txt --wrap="apptainer exec --no-mount home --bind $PWD gvhd_R4.3.1.sif Rscript ExtData_Figure_3g.R")
jid44=$(sbatch --mem=10g --time=0-1 --parsable --dependency=afterok:$jid43 -N 1 -n 1 -o ./slurmOut/ExtData_Figure_3h_%j.txt --wrap="apptainer exec --no-mount home --bind $PWD gvhd_R4.3.1.sif Rscript ExtData_Figure_3h.R")
jid45=$(sbatch --mem=10g --time=0-1 --parsable --dependency=afterok:$jid44 -N 1 -n 1 -o ./slurmOut/ExtData_Figure_3i_%j.txt --wrap="apptainer exec --no-mount home --bind $PWD gvhd_R4.3.1.sif Rscript ExtData_Figure_3i.R")

## Figure 4


jid46=$(sbatch --mem=10g --time=0-7 --parsable -N 1 -n 1 -o ./slurmOut/human_ATAC_peak_union_set_%j.txt --wrap="apptainer exec --no-mount home --bind $PWD gvhd_R4.3.1.sif ipython human_ATAC_peak_union_set.py")
...
jid53=$(sbatch --mem=100g --time=0-2 --parsable --dependency=afterok:$jid52 -N 1 -n 20 -o ./slurmOut/integrate_human_scATAC.txt --wrap="apptainer exec --no-mount home --bind $PWD gvhd_R4.3.1.sif Rscript integrate_human_scATAC.R")
jid54=$(sbatch --mem=100g --time=0-3 --parsable --dependency=afterok:$jid53 -N 1 -n 1 -o ./slurmOut/addPseudoExpression_integrated_human_scATAC_%j.txt --wrap="apptainer exec --no-mount home --bind $PWD gvhd_R4.3.1.sif Rscript addPseudoExpression_integrated_human_scATAC.R")
jid55=$(sbatch --mem=40g --time=0-1 --parsable --dependency=afterok:$jid54 -N 1 -n 1 -o ./slurmOut/Figure_4f_g_%j.txt --wrap="apptainer exec --no-mount home --bind $PWD gvhd_R4.3.1.sif Rscript Figure_4f_g.R")
jid56=$(sbatch --mem=75g --time=0-1 --parsable --dependency=afterok:$jid55 -N 1 -n 20 -o ./slurmOut/scATAC_signal_at_bulk_ILC2_pcILC2_randomILC2_peaks_%j.txt --wrap="apptainer exec --no-mount home --bind $PWD gvhd_R4.3.1.sif Rscript scATAC_signal_at_bulk_ILC2_pcILC2_sharedILC2_peaks.R")
jid57=$(sbatch --mem=20g --time=0-1 --parsable --dependency=afterok:$jid56 -N 1 -n 1 -o ./slurmOut/Figure_4h_i_ExtData_Fig4a_%j.txt --wrap="apptainer exec --no-mount home --bind $PWD gvhd_R4.3.1.sif Rscript Figure_4h_i_ExtData_Fig4a.R")
